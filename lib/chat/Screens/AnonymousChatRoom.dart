...
class AnonymousChatRoom extends StatefulWidget {
  final String chatRoomId,uid,name;

  AnonymousChatRoom({required this.chatRoomId,required this.uid,required this.name});

  @override
  State<AnonymousChatRoom> createState() => _AnonymousChatRoomState();
}
